...
var box_x = box_box_2.getAttribute("x");
var box_y = box_box_2.getAttribute("y");
...
setInterval(function(){
  ...
  box_box_2.style.top = box_y+'px';
	box_box_2.style.left = box_x+'px';
  box_box_2.setAttribute("x", box_x);
  box_box_2.setAttribute("y", box_y);
	box_box_1.style.top = box_all["player1"]["pos_y"]+'px';
  box_box_1.style.left = box_all["player1"]["pos_x"]+'px';
