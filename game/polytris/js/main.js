function scaleCanvas() {
	...
	if (canvas.height > canvas.width) {
		settings.scale = (canvas.width / 1000) ;
	} else {
		settings.scale = (canvas.height / 1000);
	}
