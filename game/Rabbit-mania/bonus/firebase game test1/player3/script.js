...
var box_x = box_box_3.getAttribute("x");
var box_y = box_box_3.getAttribute("y");
...
setInterval(function(){
  ...
  box_box_3.style.top = box_y+'px';
	box_box_3.style.left = box_x+'px';
  box_box_3.setAttribute("x", box_x);
  box_box_3.setAttribute("y", box_y);
