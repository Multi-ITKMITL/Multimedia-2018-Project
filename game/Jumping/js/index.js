...
Jumper.Play.prototype = {
  ...
  heroCreate: function() {
    // basic hero setup
    this.hero = game.add.sprite( this.world.centerX, this.world.height - 39, 'hero' );
    ...
    // track where the hero2 started and how much the distance has changed from that point
    this.hero2.yOrig = this.hero2.y;
    this.hero2.yChange = 0;

    // hero2 collision setup
    // disable all collisions except for down
