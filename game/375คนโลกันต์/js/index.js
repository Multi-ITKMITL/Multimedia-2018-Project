...
Player.prototype.draw = function() {
  var image = new Image();
  image.src = "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/intermediary/f/f82dc1a7-8b0b-495d-bab6-b97798f49ce4/dbwh40a-2466e07d-5072-4a4a-b248-1dad0272e0cf.png/v1/fill/w_226,h_250,strp/nero_claudius_navidad___padoru_padoru_by_alexzer09_dbwh40a-250t.png  "
  InfiniteRunner.drawImage(image, this.x, this.y, this.width, this.height);
};
...
Platform.prototype.draw = function() {
  ...
  image2.src = "https://i.ibb.co/SKVjVJ8/building.png";
  InfiniteRunner.drawImage(image2,this.x, this.y, this.width, this.height);
};
...
InfiniteRunner.setup = function () {
  ...
  this.player = new Player({x: 150, y: 30, width: 35, height: 35});
...
InfiniteRunner.draw = function(){
  ...
  this.fillText('SCORE: '+this.jumpCount, this.width - (150 + (this.aceleration * 4)), 50);
