...
var box_x = box_box_5.getAttribute("x");
var box_y = box_box_5.getAttribute("y");
...
setInterval(function(){
  ...
  box_box_5.style.top = box_y+'px';
	box_box_5.style.left = box_x+'px';
  box_box_5.setAttribute("x", box_x);
  box_box_5.setAttribute("y", box_y);
