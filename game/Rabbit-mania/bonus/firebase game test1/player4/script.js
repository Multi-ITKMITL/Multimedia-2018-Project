...
var box_x = box_box_4.getAttribute("x");
var box_y = box_box_4.getAttribute("y");
...
setInterval(function(){
  ...
  box_box_4.style.top = box_y+'px';
	box_box_4.style.left = box_x+'px';
  box_box_4.setAttribute("x", box_x);
  box_box_4.setAttribute("y", box_y);
